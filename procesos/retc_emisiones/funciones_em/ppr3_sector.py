...
cname = "logs_db/establecimientos_update_nombre_sector_"+str(ct) + ".log"
...
try:
    ...
    input_path="categorias/dbppr_v1_es_sectores_list.csv"
    ...
    for index, emisora in df.iterrows():
        logging.info("\tActualizando el sector de {} a {}".format(emisora["sector"], emisora["mod"]))
